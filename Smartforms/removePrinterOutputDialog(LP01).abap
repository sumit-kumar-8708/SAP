...
wa_control_parameters-no_dialog = 'X'. " means do not show the print/output dialog.
wa_control_parameters-preview   = 'X'. " means directly open Smart Form preview.

wa_output_options-tddest        = 'LP01'. " Spool: Output device
" Do not force printer LP01
*CLEAR ls_output-tddest.
...
*   MAIL_SENDER        =
    ...
    user_settings      = ' ' " empty pass means -> false value
    p_vbeln            = p_vbeln
    wa_vbak            = wa_vbak
